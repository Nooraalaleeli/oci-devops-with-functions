...
# === FaaS and Admin Policies (Commented out - requires IAM admin permissions) ===
...
#   statements = [
#     "Allow group Administrators to manage functions-family in compartment id ${var.compartment_ocid}",
